...
$(document).on(
  "click",
  ".modal__box.about .modal__box__inner .modal__close__btn",
  function () {
...
$(document).on(
  "click",
  "#news .list-inner .detail .read-more-btn a, #news .list-inner .detail .title a",
  function () {
...
$(document).on(
  "click",
  ".modal__box.news .modal__box__inner .modal__close__btn",
  function () {
...
$(document).on("click", ".list-wr.portfolio ul > li", function (e) {
  ...
  function openModalContent(content) {
    $(
      ".modal__box__content .modal__box__inner .modal__content .iframe-scaler"
    ).html(content);
...
$(document).on(
  "click",
  ".modal__box__content .modal__box__inner .modal__content .modal__close__btn",
  function () {
    $(".modal__box__content.opened").removeClass("opened");
    setTimeout(() => {
      $(
...
$(window).on("click", function (e) {
  if (!window.getSelection().toString()) {
    if (
      e.target == $(".lightbox-wrapper")[0] ||
      e.target == $(".lightbox-content")[0] ||
      e.target == $(".lightbox-description")[0]
    ) {
...
$(document).on(
  "click",
  ".settings-wr .settings-content .colors li a",
  function (e) {
    e.preventDefault();
...
$(document).on(
  "click",
  ".settings-wr .settings-content .cursor li a",
  function (e) {
    e.preventDefault();

    $(
      ".settings-content .cursor li a.magic-cursor-btn, .settings-content .cursor li a.def-cursor-btn"
    ).toggleClass("active");

    let toggleCursor =
      $(".all-wr").data("magic-cursor") == "hide" ? "show" : "hide";
